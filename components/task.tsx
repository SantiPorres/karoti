...
export default function Task(
{
    ...
    return (
        <div className="w-full flex flex-wrap gap-y-1 items-center border-b pb-4 p-1">
            <div className="w-full flex gap-2 md:w-10/12 items-center md:pr-4">
                {/* Checkbox and input */}
            ...
            <div className="flex gap-2 items-center w-full md:w-2/12">
            {titleInput !== task.title ? 
                ...
                <Select value={task.priority_id} disabled={task.done} onValueChange={(value) => updateTask(task.id, { priority_id: value as TaskType["priority_id"] })}>
                    <SelectTrigger className="border-0 w-fit ml-auto">
